  ...
  <div class="justify-content-between d-flex mb-3">
    ...
    <div class="bg-gradient">
      ...
      <nav class="nav justify-content-center mt-4 mb-4">
        <!-- <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" name="badge"> 99+ </span> -->
        ...
        <a class="position-relative nav-link btn btn-light" href="<?php url("/movies/comments") ?>">Comments</a>
      ...
      <div class="">
      <a href="https://www.facebook.com/samuelpeter.eigbe" class="mx-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-facebook text-light bg-dark rounded-4 bg-cover" viewBox="0 0 16 16">
                 <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                 </svg></a> 
                 <a href="https://wa.me/+2347063137059" class="mx-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-whatsapp text-light bg-dark rounded-circle" viewBox="0 0 16 16">
                  ...
                  <a href="https://www.linkedin.com/in/peter-eigbe-687a3928b/" class="mx-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-linkedin text-light bg-dark rounded-5" viewBox="0 0 16 16">
          ...
          <?php foreach ($rows as $row): ?>
            <div class="col-xxl-6 col-lg-12 col-md-12 col-sm-12 mb-4">
              <div class="card h-100 rounded-5 shadow" style="max-width:700px">
                <div class="row">
                  <div class="col-md-5">
                    <img src="<?php url('/assets/img/');
                    echo $row['images'] ?>" class="image-fluid rounded-5 w-100" alt="...">
                  </div>
                  <div class="col-md-7">
                    <div class="card-body">
                      ...
                      <p class="card-text mt-3 mb-0"><span class="fw-bold"> Stars: </span><?php echo $row['main_star'] ?> </p>
                      <p class="card-text mb-0"><span class="fw-bold"> Released Date: </span><?php echo $row['release_year'] ?></p>
