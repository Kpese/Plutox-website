            ...
            <div class="row gx-0 align-items-stretch">
              ...
              <div class="col-lg-4">
                <div class="info d-flex justify-content-center flex-column p-4 h-100">
                  <div class="py-5 px-3">
                    ...
                    <p class="fw-light fs-3 mb-0">Register</p>
                  </div>
                </div>
              </div>
              <!-- Form Panel    -->
              <div class="col-lg-8 bg-white">
                ...
                <div class="d-flex align-items-center px-4 px-lg-5 h-100">
                  ...
                  <form class="register-form py-5 w-100" method="POST" action="<?php url('/movies/signup') ?>">
                    <div class="input-material-group mb-3">
                      <input class="input-material" type="text" required name="name" value="<?php echo isset($_POST['name']) ? htmlspecialchars(ucfirst($_POST['name'])) : ''  ?>">
                    ...
                    <div class="input-material-group mb-4">
                      <input class="input-material" type="password" name="password"  value="<?php echo isset($_POST['password']) ? htmlspecialchars($_POST['password']) : ''  ?>">
                    ...
                    <button class="btn btn-primary mb-3" name="moviesubmit" type="submit">Register</button><br><small class="text-gray-500">Already have an account?  </small><a class="text-sm text-paleBlue" href="<?php url('/movies/signin') ?>">Login</a>
                  </form>
                </div>
              </div>
            </div>
