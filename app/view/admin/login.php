            ...
            <div class="row gx-0 align-items-stretch">
              ...
              <div class="col-lg-4">
                <div class="info d-flex justify-content-center flex-column p-4 h-100">
                  <div class="py-5 px-3">
                    ...
                    <p class="fw-light fs-3 mb-0">Admin Login.</p>
                  </div>
                </div>
              </div>
              <!-- Form Panel    -->
              <div class="col-lg-8 bg-white">
                ...
                <div class="d-flex align-items-center px-4 px-lg-5 h-100">
                  <form class="login-form py-5 w-100" method="POST" action="<?php url('/admin/login') ?>">
                  <div class="input-material-group mb-3">
                    ...
                    <div class="input-material-group mb-4">
                      <input class="input-material" id="login-password" type="password" name="adminPassword" value="<?php echo isset($_POST['adminName']) ? $_POST['adminName'] : '' ?>">
                      <label class="label-material" for="login-password">Password</label>
                    </div>
                    <button class="btn btn-primary mb-3" name="submit" type="submit">Login</button><br><a class="text-sm text-paleBlue" href="#">Forgot Password?</a><br><small class="text-gray-500">Do not have an account? </small><a class="text-sm text-paleBlue" href="<?php url('/admin/register') ?>">Signup</a>
                  </form>
                </div>
              </div>
            </div>
